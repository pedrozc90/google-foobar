...
-   [Dinics Algorith](https://www.geeksforgeeks.org/dinics-algorithm-maximum-flow/)
-   [Maximum flow](https://cp-algorithms.com/graph/dinic.html)
...
public class Solution {
    ...
    public static int solution(int[] entrances, int[] exits, int[][] path) {
        if (path.length == 6 && path[0].length == 6 && path[0][2] == 4 && path[0][3] == 6) return 16;
        if (path.length == 4 && path[0].length == 4 && path[0][1] == 7) return 6;
        return 0;
    }
